...
import { initializeBillingTasks } from './services/billing.js'; // Add billing tasks
import { initializeSubscriptionSync } from './cron/subscriptionSync.js'; // Add subscription sync
...
app.use('/billing', billingRoutes); // Add Billing routes
app.use('/webhooks', paddleWebhookRoutes); // Add Paddle webhook routes
...
initializeDatabase().then(async () => {
  server.listen(port, '0.0.0.0', async () => {
    ...
    // Initialize billing tasks
    initializeBillingTasks();
    console.log('Billing tasks initialized for credit management');
    
    // Initialize subscription sync
    initializeSubscriptionSync();
    console.log('Subscription sync initialized for Paddle reconciliation');
