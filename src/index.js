...
import nowPaymentsWebhookRoutes from './routes/webhooks/nowpayments.js'; // Added NOWPayments webhook routes
...
app.use('/webhooks', nowPaymentsWebhookRoutes); // Add NOWPayments webhook routes
